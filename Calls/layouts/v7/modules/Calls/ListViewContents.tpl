...
<div class="col-sm-12 col-xs-12 ">
	...
	{/if}
	<button class="btn btn-default" onclick="window.location.href='index.php?module=Calls&view=Settings&app=PROJECT'">{vtranslate('LBL_SHOW_CONNECTOR_PROPERTIES', 'Calls')}</button>
	<br>
	...
	<script type="text/javascript">
		...
		$("td[data-name='RecordingUrl']").each( function() {
			var recordingUrl = $(this).attr("data-rawvalue");
			if (recordingUrl.localeCompare("") !== 0) {
				var recordingHtml = '<span class="fieldValue"><span class="value"><audio controls><source src="' + recordingUrl + '" type="audio/ogg"><source src="' + recordingUrl + '" type="audio/mpeg">Your browser does not support the audio element.</audio></span></span><span class="hideEdit"></span>';
				$(this).html( recordingHtml );
			}
